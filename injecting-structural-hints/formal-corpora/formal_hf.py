...
_DATA_DIR = "formal-corpora/data" #"synthetic_corpora/data"
...
class Synthetic(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        ...
        SyntheticConfig(
            name="natlang-parens-eng_vocab500",
            data_dir = os.path.join(_DATA_DIR, "natlang-parens-eng_vocab500"),
            description="Empirical dependencies",
        )
        ]
